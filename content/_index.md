...
Since data is the fuel for ML, my research aims to develop systematic data-centric approaches applicable to different data modalities (tabular, image & text) --- with the goal of making ML systems more reliable & trustworthy 🦾, whilst also improving both model performance & training efficiency 🚀. Most recently on **Large Language Models (LLM)s**!
